...
#define STRING_CONFIG_H_AUTHOR "(TRONXY X5S, 1.1.9)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 209.1 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 2.66   // Z offset: -below +above  [the nozzle]
